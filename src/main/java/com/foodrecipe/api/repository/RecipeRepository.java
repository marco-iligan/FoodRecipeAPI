...
public interface RecipeRepository extends JpaRepository<Recipe, Long> {
    ...
    @Query(value="select r1_0, p1_0 from Recipe r1_0 join Profile p1_0 join Ingredients i1_1 where p1_0.userId=?1 and concat(r1_0.title,r1_0.description,r1_0.category, i1_1.name,i1_1.description) like %?2%")
